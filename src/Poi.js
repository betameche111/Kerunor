...
import EltagarPoint from "./assets/img/Eltagar.svg";
import EltagarPointHover from "./assets/img/Eltagar_hover.svg";
...
var EltagarContinent = new Sprite(poiSpriteMaterial);// eltagarSpriteMaterial); // Choix du Nom du POI (Il faut le changer dans tout le bloc ensuite)
...
EltagarContinent.text = ["j'aime la bite et le paté ", "<p>Attention Vent qui mord</p> <p>mais ne vous inquietez pas il est quand meme gentil</p>"]; // Choix des textes pour le POI (remplacer les retours à la ligne par \n)
EltagarContinent.icon = poiSpriteMaterial;//eltagarSpriteMaterial; // Ne changer que le nom
EltagarContinent.hoverIcon = poiSpriteHoverMaterial;//eltagarSpriteHoverMaterial; // Ne changer que le nom
...
var PoiLaDesolationDeChereskan = new Sprite(poiSpriteMaterial); // Choix du Nom du POI (Il faut le changer dans tout le bloc ensuite)
...
PoiLaDesolationDeChereskan.icon = poiSpriteMaterial; // Ne changer que le nom
PoiLaDesolationDeChereskan.hoverIcon = poiSpriteHoverMaterial; // Ne changer que le nom
Poi.push(PoiLaDesolationDeChereskan); // Ne changer que le nom

var PoiLeDesertDeRenzary = new Sprite(poiSpriteMaterial); // Choix du Nom du POI (Il faut le changer dans tout le bloc ensuite)
...
PoiLeDesertDeRenzary.icon = poiSpriteMaterial; // Ne changer que le nom
PoiLeDesertDeRenzary.hoverIcon = poiSpriteHoverMaterial; // Ne changer que le nom
Poi.push(PoiLeDesertDeRenzary); // Ne changer que le nom

var PoiLesMontsGlacesDeTarguenor = new Sprite(poiSpriteMaterial); // Choix du Nom du POI (Il faut le changer dans tout le bloc ensuite)
...
PoiLesMontsGlacesDeTarguenor.icon = poiSpriteMaterial; // Ne changer que le nom
PoiLesMontsGlacesDeTarguenor.hoverIcon = poiSpriteHoverMaterial; // Ne changer que le nom
Poi.push(PoiLesMontsGlacesDeTarguenor); // Ne changer que le nom

var PoiLesRuinesDeXeros = new Sprite(poiSpriteMaterial); // Choix du Nom du POI (Il faut le changer dans tout le bloc ensuite)
...
PoiLesRuinesDeXeros.icon = poiSpriteMaterial; // Ne changer que le nom
PoiLesRuinesDeXeros.hoverIcon = poiSpriteHoverMaterial; // Ne changer que le nom
